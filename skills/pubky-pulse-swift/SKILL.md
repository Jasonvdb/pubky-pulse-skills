...
the `pubky-pulse-instrument` step-4 gate asks, and the answer is what the App Store privacy
manifest declares. With no answer, write it commented out at the callsite with a one-line
